  ...
  return (
    <div className="bg-gray-300 h-[90vh]">
      <div className="flex flex-col items-center justify-center py-5">
        <div className="w-[35%] h-[35%] rounded-full flex items-center overflow-hidden  justify-center ">
          <img
        ...
        <div className="my-3 grid grid-cols-2">
          <h4 className="text-lg font-medium mr-3">Name :</h4>
          <p>Souban </p>
          <h4 className="text-lg font-medium mr-3">age :</h4>
          <p>22 </p>
          <h4 className="text-lg font-medium mr-3">Name :</h4>
          <p>Souban </p>
          <h4 className="text-lg font-medium mr-3">Name :</h4>
